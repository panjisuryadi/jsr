...
namespace Modules\DataBank\Http\Controllers;
use Carbon\Carbon;
...
class DataBanksController extends Controller
{
  ...
  public function __construct()
    {
        // Page Title
        $this->module_title = 'Data Bank';
        $this->module_name = 'databank';
        $this->module_path = 'databanks';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\DataBank\Models\DataBank";
...

    {
        ...
        return Datatables::of($$module_name)
                        ->addColumn('action', function ($data) {
                          ...
                          ->editColumn('no_akun', function ($data) {
                             $tb = '<div class="items-center text-center">
...
public function update(Request $request, $id)
    {
        ...
        $validator = \Validator::make($request->all(),
            ...
            'kode_bank' => [
                'required',
                'unique:'.$module_model.',kode_bank,'.$id
            ],
            'nama_bank' => 'required|max:191',
            'no_akun' => 'required|max:191',

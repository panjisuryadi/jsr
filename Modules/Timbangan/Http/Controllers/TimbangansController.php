...
namespace Modules\Timbangan\Http\Controllers;
use Carbon\Carbon;
...
class TimbangansController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'Timbangan';
        $this->module_name = 'timbangan';
        $this->module_path = 'timbangans';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\Timbangan\Models\Timbangan";
...

    {
        ...
        return Datatables::of($$module_name)
                        ->addColumn('action', function ($data) {
                          ...
                          ->editColumn('old_weight', function ($data) {
...
public function store(Request $request)
    {
        ...
        $validator = \Validator::make($request->all(),[
             'old_weight' => 'required|numeric|min:20',
             'new_weight' => 'required|numeric|gt:min_price',

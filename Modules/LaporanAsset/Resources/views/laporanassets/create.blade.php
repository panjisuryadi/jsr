@extends('layouts.app')
@section('title', 'Create LaporanAsset')
@section('breadcrumb')
<ol class="breadcrumb border-0 m-0">
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
    <li class="breadcrumb-item"><a href="{{ route("laporanasset.index") }}">LaporanAsset</a></li>
    <li class="breadcrumb-item active">Add</li>
</ol>
@endsection
@section('content')
<div class="container-fluid">
    <form action="{{ route('laporanasset.store') }}" method="POST">
        @csrf
        <div class="row">

...
namespace Modules\GoldCategory\Http\Controllers;
use Carbon\Carbon;
...
class GoldCategoriesController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'Gold Category';
        $this->module_name = 'goldcategory';
        $this->module_path = 'goldcategories';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\GoldCategory\Models\GoldCategory";

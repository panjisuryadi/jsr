...
@push('page_scripts')
   <script type="text/javascript">
        var berlian_kategori = "{{ json_encode($berlian_kategori) }}";
        $(function(){
            datatable()
            getStockInfo()
        })
        function datatable(){
            ...
            $('#datatable').DataTable({
               ...
               "oLanguage": {
                ...
                ajax: {
                    url : '{{ route("$module_name.index_data_ready") }}?karat='+$('#karat_filter').val()+'&cabang='+$('#cabang_filter').val(),
                    data : {
                        catagories : berlian_kategori
                    },
                    dataType:'json',
        ...
        function getStockInfo(){
            $.ajax({
                type: "get",
                url: '{{ route("$module_name.get_stock_ready") }}?karat='+$('#karat_filter').val()+'&cabang='+$('#cabang_filter').val(),
                dataType:'json',
                headers: {

  ...
  public function __construct()
    {
        ...
        $this->module_name = 'accessory';
        $this->module_path = 'accessories';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\Accessory\Models\Accessory";
...
public function index_data(Request $request)
    ...
    {
         abort_if(Gate::denies('create_accessory'), 403);
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        $module_icon = $this->module_icon;
...
public function store(Request $request)
    {
        ...
        $input['code'] = Accessories::generateCode();
        $input['name'] = $input['name'];
        $input['amount'] = $input['amount'];
        $input['type'] = !empty($input['satuan_id']) ? $input['satuan_id'] : 3;
        $$module_name_singular = Accessories::create($input);

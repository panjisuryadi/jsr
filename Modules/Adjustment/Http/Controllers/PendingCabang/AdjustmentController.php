...
namespace Modules\Adjustment\Http\Controllers\PendingCabang;
...
class AdjustmentController extends Controller {
    ...
    public function index(){
        ...
        $location = AdjustmentSetting::LOCATION['6'];
        return view('adjustment::pending-cabang.index',compact('location'));
    }
    ...
    public function create(){
        ...
        return view('adjustment::pending-cabang.create',compact('reference','active_location'));
    }

    public function getdata(){
        $get_data = Adjustment::has('stockPendingCabang')->withCount('products');

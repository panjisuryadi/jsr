...
namespace Modules\Adjustment\Http\Controllers\PendingOffice;
...
class AdjustmentController extends Controller {
    ...
    public function index(){
        ...
        $location = AdjustmentSetting::LOCATION['3'];
        return view('adjustment::pending-office.index',compact('location'));
    }
    ...
    public function create(){
        ...
        return view('adjustment::pending-office.create',compact('reference','active_location'));
    }

    public function getdata(){
        $get_data = Adjustment::has('stockPendingOffice')->withCount('products');

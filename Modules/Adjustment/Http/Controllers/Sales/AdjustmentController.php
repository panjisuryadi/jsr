...
namespace Modules\Adjustment\Http\Controllers\Sales;
...
class AdjustmentController extends Controller {
    ...
    public function index(){
        ...
        $location = AdjustmentSetting::LOCATION['2'];
        return view('adjustment::sales.index',compact('location'));
    }
    ...
    public function create(){
        ...
        return view('adjustment::sales.create',compact('reference','active_location'));
    }

    public function getdata(){
        $get_data = Adjustment::has('stockSales')->withCount('products');

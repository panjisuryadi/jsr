...
namespace Modules\Adjustment\Http\Controllers\DP;
...
class AdjustmentController extends Controller {
    ...
    public function index(){
        ...
        $location = AdjustmentSetting::LOCATION['5'];
        return view('adjustment::dp.index',compact('location'));
    }
    ...
    public function create(){
        ...
        return view('adjustment::dp.create',compact('reference','active_location'));
    }

    public function getdata(){
        $get_data = Adjustment::has('stockDP')->withCount('products');

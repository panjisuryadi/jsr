...
@section('title', 'Adjustments Sales')
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"> @lang('Sales')</li>
    </ol>
@endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="{{ route('adjustment.sales.create') }}" class="btn btn-primary mr-2">

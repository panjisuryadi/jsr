...
@section('title', 'Adjustments Pending Cabang')
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"> @lang('Pending Cabang')</li>
    </ol>
@endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="{{ route('adjustment.pending.cabang.create') }}" class="btn btn-primary mr-2">
    ...
    function datatable(){
        $('#datatable').DataTable({
            ...
            $('#datatable').DataTable({
                ...
                ajax: {
                    url:'/adjustments/pending-cabang/getdata',
                    type:"GET",
                },
                columns: [
                    { data: 'date', name: 'date' },

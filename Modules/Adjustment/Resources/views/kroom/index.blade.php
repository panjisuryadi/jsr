...
@section('title', 'Adjustments Kroom')
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"> @lang('Kroom')</li>
    </ol>
@endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="{{ route('adjustment.kroom.create') }}" class="btn btn-primary mr-2">

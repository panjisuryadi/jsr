@extends('layouts.app')
@section('title', 'Create JenisPerhiasan')
@section('breadcrumb')
<ol class="breadcrumb border-0 m-0">
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
    <li class="breadcrumb-item"><a href="{{ route("jenisperhiasan.index") }}">JenisPerhiasan</a></li>
    <li class="breadcrumb-item active">Add</li>
</ol>
@endsection
@section('content')
<div class="container-fluid">
    <form action="{{ route('jenisperhiasan.store') }}" method="POST">
        @csrf
        <div class="row">
             ...
             id="{{ $field_name }}" rows="4 " class="form-control {{ $invalid }}"></textarea>
               ...
               @if ($errors->has($field_name))
                        ...
                        <div class="flex justify-between">
                            ...
                            href="{{ route("jenisperhiasan.index") }}">
                            @lang('Cancel')</a>

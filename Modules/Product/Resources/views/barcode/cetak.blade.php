...
<table class="table borderless">
      ...
      <tr style="border:none !important;" >
        ...
        <td  class ="text-dark" style="width:40%;border:none !important;text-align: left;">
          <div style="relative">
            <div style="position:absolute; top:0.9rem;font-size: 0.9rem;left:1rem;">
              <img width="35" src="data:image/png;base64, {!! $barcode !!}">   
            </div>
            <div style="position:absolute; bottom:1.9rem;left:1rem;">
        ...
        <td style="border:none !important;">
          <div style="relative">
            <div class="tf" style="position:absolute; top:0.7rem;right:2.3rem;">
              <div style="font-size: 0.65rem; font-weight: bold;" class="qr-dark">
                  {{$product->product_name}}
              </div>
              <div style="font-size: 1rem;  font-weight: bold;" class="qr-dark">
            ...
            <div style="position:absolute; bottom:2.2rem;right:2.3rem;">

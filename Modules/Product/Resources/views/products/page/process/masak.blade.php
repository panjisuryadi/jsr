...
<ol class="breadcrumb border-0 m-0">
    ...
    <li class="breadcrumb-item active">Masak</li>
</ol>
@endsection
@section('content')
                ...
                <div class="card-body">
                    <div class="flex justify-between py-1 border-bottom">
                     <div>
                      ...
                      Proses 
                      <span class="text-yellow-500 uppercase">Masak</span>
                  </p>
                        </div>
                        <div id="buttons">
                        </div>
...
@push('page_scripts')
   <script type="text/javascript">
        ...
        function datatable(){
            ...
            $('#datatable').DataTable({
               ...
               "oLanguage": {
                ...
                ajax: '{{ route("products.process.get_masak") }}?karat='+$('#karat_filter').val(),
                dom: 'Blfrtip',
                buttons: [
                    'excel',
                    'pdf',
        ...
        function getStockInfo(){
            $.ajax({
                type: "get",
                url: '{{ route("products.get_stock_masak") }}?karat='+$('#karat_filter').val(),
                dataType:'json',
                headers: {

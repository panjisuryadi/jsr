...
<ol class="breadcrumb border-0 m-0">
    ...
    <li class="breadcrumb-item active">Cuci</li>
</ol>
@endsection
@section('content')
...
@push('page_scripts')
   <script type="text/javascript">
        ...
        function datatable(){
            ...
            $('#datatable').DataTable({
               ...
               "oLanguage": {
                ...
                ajax: '{{ route("products.process.get_cuci") }}?karat='+$('#karat_filter').val(),
                dom: 'Blfrtip',
                buttons: [
                    'excel',
                    'pdf',
        ...
        function getStockInfo(){
            $.ajax({
                type: "get",
                url: '{{ route("products.get_stock_cuci") }}?karat='+$('#karat_filter').val(),
                dataType:'json',
                headers: {

...
<div class="flex py-0 flex-row grid grid-cols-2 gap-2">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" name="karat_berlian_id" id="karat_berlian_id" required>
            <option value="" selected disabled>Pilih Karat Berlian</option>
...
var $newRow = $("<tr id='regFacEmpType" + newRowID + "' data-parent-row='" + parent + "'>");
    $newRow.append($(`<td align='center'>
        <select class="form-control form-control-sm" name="round_id" id="round_id" required="">
            <option value="" selected="" disabled="">Select</option>
            <option value="1">c230</option>
        </select>
    </td>`));
    $newRow.append($("<td></td>")
    .append($(`<select class="form-control form-control-sm" name="round_id" id="round_id" required="">
        <option value="" selected="" disabled="">Select</option>
        <option value="1">c230</option>
    </select>`)
    .bind("click", addRow)));

...
<ol class="breadcrumb border-0 m-0">
    ...
    <li class="breadcrumb-item active">Add Products Purchase</li>
</ol>
@endsection
@section('content')
...
<div class="flex flex-row px-1 py-1 grid grid-cols-4 gap-3 m-2 text-center no-underline">
@foreach($groupkategori as $category)
    <div class="no-underline cursor-pointer p-2 w-full">
           <a class="w-full no-underline hover:no-underline" id="openModalKategori"
                href="{{ route('products.add_products_group_categories',$category->id) }}" >

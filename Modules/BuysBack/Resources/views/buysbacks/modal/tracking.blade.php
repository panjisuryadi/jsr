    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-lg font-bold" id="addModalLabel">Tracking Nota BuyBack</h3>
                ...
                <div class="bg-white px-4 overflow-hidden py-2">
                    ...
                    <div class="flex justify-between px-1 py-3 border px-4 rounded">
                        ...
                        <div class="text-gray-600">
                            ...
                            <div>
                                Dibuat oleh: <strong>{{ $buyback_nota->pic->name }}</strong>
                            </div>
                        </div>
                    ...
                    <div class="w-full  mx-auto relative py-0">
                        ...
                        <div class="border-l-2 mt-2">
                            <!-- Card 1 -->
                            @foreach ($buyback_nota->history as $history )

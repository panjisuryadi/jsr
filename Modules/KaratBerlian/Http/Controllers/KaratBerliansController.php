...
namespace Modules\KaratBerlian\Http\Controllers;
use Carbon\Carbon;
...
class KaratBerliansController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'KaratBerlian';
        $this->module_name = 'karatberlian';
        $this->module_path = 'karatberlians';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\KaratBerlian\Models\KaratBerlian";
...
public function index_data(Request $request)

    {
        ...
        return Datatables::of($$module_name)
                        ...
                        ->rawColumns(['updated_at', 'action','code', 'name'])
                        ->make(true);
                     }

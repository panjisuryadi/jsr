  ...
  <form id="FormTambah" action="{{ route("$module_name.store") }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group mb-0">
                        <label for="jenis_mutiara_id">@lang('Jenis Group') <span class="text-danger">*</span></label>
                        <select class="form-control" name="jenis_mutiara_id" id="jenis_mutiara_id" required>
                            <option value="" selected disabled>Select Jenis Mutiara</option>
                            @foreach(\Modules\JenisMutiara\Models\JenisMutiara::all() as $jg)

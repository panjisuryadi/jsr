...
namespace Modules\KodeTransaksi\Http\Controllers;
use Carbon\Carbon;
...
class KodeTransaksisController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'Kode Transaksi';
        $this->module_name = 'kodetransaksi';
        $this->module_path = 'kodetransaksis';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\KodeTransaksi\Models\KodeTransaksi";

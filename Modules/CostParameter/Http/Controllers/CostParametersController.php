...
namespace Modules\CostParameter\Http\Controllers;
use Carbon\Carbon;
...
class CostParametersController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'Cost Parameters';
        $this->module_name = 'costparameter';
        $this->module_path = 'costparameters';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\CostParameter\Models\CostParameter";
...
public function store(Request $request)
    {
        ...
        $validator = \Validator::make($request->all(),[
             'kode_prefix' => 'required|max:191|unique:'.$module_model.',kode_prefix',
       ...
       // $input = $request->all();
        ...
        $input['kode_prefix'] = $input['kode_prefix'];
...
public function update(Request $request, $id)
    {
        ...
        $validator = \Validator::make($request->all(),
            ...
            'kode_prefix' => [
                'required',
                'unique:'.$module_model.',kode_prefix,'.$id
            ],
            'nominal' => 'required|max:191',

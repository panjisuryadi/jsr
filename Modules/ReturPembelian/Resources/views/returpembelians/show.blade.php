...
<ol class="breadcrumb border-0 m-0">
    ...
    <li class="breadcrumb-item"><a href="{{ route('returpembelian.index') }}">{{$module_title}}</a></li>
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="text-lg bg-white flex justify-between w-full px-2 py-3">
            <div class="px-3 py-2">
                <div class="mt-3 text-gray-600">No Retur</div>
                <h3 class="font-medium text-gray-900 uppercase font-medium font-semibold">{{ $detail->retur_no }}</h3>
            </div>
            <div class="px-6 py-2">

                <div class="flex flex-row justify-end">
                    <a class="flex" href="{{ route('penjualansale.index') }}">
            ...
            <div class="bg-white grid grid-cols-3 gap-4">
                <div class="text-gray-600 px-2 py-2">
                    <div class="text-sm px-3 py-2 poppins">
                        ...
                        <div class="flex justify-between w-full py-1">
                            <p class="poppins text-gray-600">{{ Label_case('No Retur') }}</p>
                            <p class="poppins dark:text-gray-300 text-gray-800">{{ $detail->retur_no }}</p>
                        </div>
                ...
                <div class="text-gray-600 col-span-2 px-2 py-2 border-l">
                    ...
                    <div class="flex items-center">
                        <h4 class="flex-shrink-0 pr-4 bg-white text-sm leading-5 tracking-wider font-semibold uppercase text-teal-600">
                            Item
                        </h4>

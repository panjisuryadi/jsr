...
namespace Modules\JenisBuyBack\Http\Controllers;
use Carbon\Carbon;
...
class JenisBuyBacksController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'Jenis BuyBack';
        $this->module_name = 'jenisbuyback';
        $this->module_path = 'jenisbuybacks';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\JenisBuyBack\Models\JenisBuyBack";
        ...
        return Datatables::of($$module_name)
                        ->addColumn('action', function ($data) {
                          ...
                          ->editColumn('name', function ($data) {
                             ...
                             $tb = '<div class="leading-1 text-gray-500 text-left">
                                     ' .$data->description . '
                                    </div>';
                                return $tb;
                            })
                        ...
                        ->rawColumns(['updated_at', 'action', 'description', 'name'])
                        ->make(true);
                     }

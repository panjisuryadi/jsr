<div class="modal fade" id="history-modal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-lg font-bold" id="addModalLabel">History Distribusi</h3>
                ...
                <div class="bg-white px-4 overflow-hidden py-2">
                    ...
                    <div class="w-full  mx-auto relative py-0">
                        ...
                        <div class="border-l-2 mt-2">
                            <!-- Card 1 -->
                            @foreach ($dist_toko->history as $history )

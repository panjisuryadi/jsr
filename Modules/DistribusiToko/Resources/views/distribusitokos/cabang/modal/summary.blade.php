    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-lg font-bold" id="addModalLabel">Konfirmasi Penerimaan Distribusi</h3>
            ...
            <div class="modal-body p-4">
                @php
                    ...
                    $total_count = count($dist_toko_items);
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" wire:click.prevent="confirm">
                    @lang('Konfirmasi') 
                </button>
            </div>

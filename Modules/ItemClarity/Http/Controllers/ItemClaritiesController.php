...
namespace Modules\ItemClarity\Http\Controllers;
use Carbon\Carbon;
...
class ItemClaritiesController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'Clarity';
        $this->module_name = 'itemclarity';
        $this->module_path = 'itemclarities';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\ItemClarity\Models\ItemClarity";

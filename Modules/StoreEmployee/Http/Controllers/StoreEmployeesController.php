...
namespace Modules\StoreEmployee\Http\Controllers;
use Carbon\Carbon;
...
class StoreEmployeesController extends Controller
{
  ...
  public function __construct()
    {
        // Page Title
        $this->module_title = 'Data Pegawai Toko';
        $this->module_name = 'storeemployee';
        $this->module_path = 'storeemployees';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\StoreEmployee\Models\StoreEmployee";
  ...
  public function index() {
        ...
        $module_action = 'List';
       // abort_if(Gate::denies('access_storeemployee'), 403);
...
public function index_data(Request $request)
    ...
    {
         abort_if(Gate::denies('create_storeemployee'), 403);
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        $module_icon = $this->module_icon;

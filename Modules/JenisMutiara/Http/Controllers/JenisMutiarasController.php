...
namespace Modules\JenisMutiara\Http\Controllers;
use Carbon\Carbon;
...
class JenisMutiarasController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'Jenis Mutiara';
        $this->module_name = 'jenismutiara';
        $this->module_path = 'jenismutiaras';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\JenisMutiara\Models\JenisMutiara";

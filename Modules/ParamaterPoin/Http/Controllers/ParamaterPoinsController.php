...
namespace Modules\ParamaterPoin\Http\Controllers;
use Carbon\Carbon;
...
class ParamaterPoinsController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'Paramater Poin';
        $this->module_name = 'paramaterpoin';
        $this->module_path = 'paramaterpoins';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\ParamaterPoin\Models\ParamaterPoin";
...
public function index_data(Request $request)

    {
        ...
        return Datatables::of($$module_name)
                        ...
                        ->rawColumns(['updated_at', 'action', 'nominal', 'poin', 'name'])
                        ->make(true);
                     }
...
public function store(Request $request)
    {
        ...
        $input['nominal'] = $input['nominal'];
        $input['poin'] = $input['poin'];

...
class LogActivitiesController extends Controller
{
  ...
  public function __construct()
    {
        // Page Title
        $this->module_title = 'LogActivity';
        $this->module_name = 'logactivity';
        $this->module_path = 'logactivities';
...
public function index_data(Request $request)

    {
        ...
        $$module_name = $module_model::latest()->Join('users', 'activity_log.causer_id', '=', 'users.id')
    ...
    {
         abort_if(Gate::denies('create_logactivity'), 403);
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        $module_icon = $this->module_icon;

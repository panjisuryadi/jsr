@extends('layouts.app')
@section('title', 'Create ItemColour')
@section('breadcrumb')
<ol class="breadcrumb border-0 m-0">
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
    <li class="breadcrumb-item"><a href="{{ route("itemcolour.index") }}">ItemColour</a></li>
    <li class="breadcrumb-item active">Add</li>
</ol>
@endsection
@section('content')
<div class="container-fluid">
    <form action="{{ route('itemcolour.store') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-lg-6">
                                <div class="col-lg-12 flex items-center form-group" x-data="app()" x-cloak>
                                    <div class="row px-2">
                                        ...
                                        <input id="colorSelected" name="value" type="text" placeholder="Pick a color"
                                        class="form-control"
                                        readonly
                        ...
                        <div class="flex justify-between border-top pt-3">
                            <div></div>
                            <div class="form-group">

   <div class="flex justify-between py-1 border-bottom">
                        <div>
                          <h1 class="font-semibold"> @lang('Purchases Customer')</h1>
                        </div>
                        <div id="buttons_customer">
                        </div>
                    </div>
<div class="table-responsive mt-1">
    <table id="datatable_customer" style="width: 100%;z-index: 2 !important;" class="table table-bordered table-hover table-responsive-sm">
        <thead>
            <tr>
                <th style="width: 6%!important;">No</th>
                <th style="width: 9%!important;" class="text-center">{{ Label_case('reference') }}</th>
                <th style="width: 23%!important;" class="text-center">{{ __('Customer / Supplier') }}</th>
   ...
   <script type="text/javascript">
        $('#datatable_customer').DataTable({
           ...
           "oLanguage": {
            ...
            ajax: '{{ route("$module_name.index_data_type",'customer') }}',
            dom: 'Blfrtip',
            buttons: [

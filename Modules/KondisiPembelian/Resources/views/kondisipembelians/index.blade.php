                    ...
                    <div class="table-responsive mt-1">
                        <table id="datatable" style="width: 100%" class="table table-bordered table-hover table-responsive-sm">
                            <thead>
                              ...
                              <th style="width: 15%!important;" class="text-center">{{ __('Potongan Harga') }} </th>
                              <th style="width: 10%!important;" class="text-center">{{ __('Persentase') }} </th>
                              <th style="width: 15%!important;" class="text-center">{{ __('Updated') }} </th>

...
namespace Modules\StokCabang\Http\Controllers;
use Carbon\Carbon;
...
class StokCabangsController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'StokCabang';
...
public function index_data(Request $request)
    ...
    {
         abort_if(Gate::denies('create_stokcabang'), 403);
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        $module_icon = $this->module_icon;

...
class ExhibitionsController extends Controller
{
  ...
  public function __construct()
    {
        // Page Title
        $this->module_title = 'Exhibition';
        $this->module_name = 'exhibition';
        $this->module_path = 'exhibitions';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\Exhibition\Models\Exhibition";
  ...
  public function index() {
        ...
        abort_if(Gate::denies('access_'.$module_name.''), 403);
         return view(''.$module_name.'::'.$module_path.'.pages.index',
           compact('module_name',
            'module_action',
            'module_title',
...
public function index_data(Request $request)
    ...
    {
         abort_if(Gate::denies('create_exhibition'), 403);
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        $module_icon = $this->module_icon;

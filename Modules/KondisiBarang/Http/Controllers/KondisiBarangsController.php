...
namespace Modules\KondisiBarang\Http\Controllers;
use Carbon\Carbon;
...
class KondisiBarangsController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'Kondisi Barang';
        $this->module_name = 'kondisibarang';
        $this->module_path = 'kondisibarangs';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\KondisiBarang\Models\KondisiBarang";
...
public function index_data(Request $request)

    {
        ...
        return Datatables::of($$module_name)
                        ...
                        ->rawColumns(['updated_at', 'action', 'code'])
                        ->make(true);
                     }

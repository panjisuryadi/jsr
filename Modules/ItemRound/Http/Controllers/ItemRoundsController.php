...
namespace Modules\ItemRound\Http\Controllers;
use Carbon\Carbon;
...
class ItemRoundsController extends Controller
{
  ...
  public function __construct()
    {
        // Page Title
        $this->module_title = 'ItemRound';
        $this->module_name = 'itemround';
        $this->module_path = 'itemrounds';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\ItemRound\Models\ItemRound";
...
public function index_data()
    ...
    public function create()
    {
         ...
         return view('itemround::itemrounds.create', compact('module_action'));
    }
    ...
    {
         abort_if(Gate::denies('create_itemround'), 403);
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        $module_icon = $this->module_icon;

...
namespace Modules\DataEtalase\Http\Controllers;
use Carbon\Carbon;
...
class DataEtalasesController extends Controller
{

  public function __construct()
    {
        // Page Title
        $this->module_title = 'Master Etalase';
        $this->module_name = 'dataetalase';
        $this->module_path = 'dataetalases';
        $this->module_icon = 'fas fa-sitemap';
        $this->module_model = "Modules\DataEtalase\Models\DataEtalase";

            ...
            <div class="card">
                <div class="card-body">
                    <div class="flex justify-between pb-3 border-bottom">
                        <div> 
                            <span class="text-lg font-semibold"> {{ $goodsreceipt->date }} | {{ $goodsreceipt->code }}</span>
                        </div>
                        <div id="buttons"></div>
                    </div>
                        ...
                        <table id="datatable" style="width: 100%" class="table table-bordered table-hover table-responsive-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 14%!important;" class="text-center">{{ Label_case('Berat Emas') }}</th>
...
<script type="text/javascript">
    ...
    $('#datatable').DataTable({
        ...
        // ajax: '{{ route("products.index_data") }}',
        ajax: '/penerimaan-barangs/qr_data/{{ $id }}',
        dom: 'Blfrtip',
        buttons: [
            {
                    extend: 'excel',

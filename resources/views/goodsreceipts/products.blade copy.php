                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="">
                            ...
                            <input type="text" class="form-control" value="{{ $input['tanggal'] }}" readonly>
                            <label for="" class="mt-2">Catatan</label>
                            <input type="text" class="form-control" value="{{ $input['catatan'] }}" readonly>
                            ...
                            <input type="text" class="form-control" value="{{ $input['total_berat_real'] }}" readonly>
                            ...
                            <input type="text" class="form-control" value="{{ $input['yang_harus_dibayar'] }}" readonly>
                        </div>

        ...
        <div class="card-body">
            <div class="form-group mb-0">
                <div class="input-group">
                    ...
                    <input wire:keydown.escape="resetQuery" wire:model.debounce.500ms="query" type="text" class="form-control" placeholder="@lang('Type product name or code') ....">
                </div>
            </div>
        </div>
    </div>
                        ...
                        @foreach($search_results as $result)
                            <li class="list-group-item list-group-item-action">
                                <a wire:click="resetQuery" wire:click.prevent="selectProduct({{ $result }})" href="#">
                                    {{ $result->product_name }} | {{ $result->product_code }} | {{$result->meter}}
                                </a>
                            </li>
                        @endforeach

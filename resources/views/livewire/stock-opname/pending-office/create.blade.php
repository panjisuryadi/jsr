<div class="row mt-0 p-3">
    ...
    <div class="col-md-5 bg-white">
        <div class="pt-3">
            @if($active_location['id'] == '3')
            <?php
            $model = "Modules\Stok\Models\StockPendingOffice";
            ?>
            <livewire:stock-opname.pending-office.table :active_location="$active_location" :model="$model" />
            @endif
        </div>
    </div>

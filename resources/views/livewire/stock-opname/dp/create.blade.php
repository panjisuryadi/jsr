<div class="row mt-0 p-3">
    ...
    <div class="col-md-5 bg-white">
        <div class="pt-3">
            @if($active_location['id'] == '5')
            <?php
            $model = "Modules\Stok\Models\StokDp";
            ?>
            <livewire:stock-opname.dp.table :active_location="$active_location" :model="$model" />
            @endif
        </div>
    </div>
                        ...
                        <table class="table table-sm table-bordered" id="tablelist">
                            <thead>
                                <tr class="align-middle">
                                    ...
                                    <th class="align-middle">@lang('Nama Cabang')</th>

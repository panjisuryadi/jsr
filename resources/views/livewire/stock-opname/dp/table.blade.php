<div>
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    <select name="cabang_id" id="cabang_id" wire:model="cabang_id" class="form-control">
       ...
       <div class="col-md-6 col-sm-6">
        ...
        <table class="table table-sm table-striped" style="width: 100%;">
            ...
            style="cursor: pointer;"> Tambah
                ...
                @livewire('stock-opname.dp.modal', ['data'=>$value,'key'=>$value->id,'active_location' => $active_location['label']],key('modal-'.$value->id))
                @endforeach
                @else
                <tr>

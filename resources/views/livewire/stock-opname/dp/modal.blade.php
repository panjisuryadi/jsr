<div class="modal fade" id="addModal{{$key}}" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        ...
        <div class="modal-header">
            <h3 class="modal-title" id="addModalLabel">Proses Opname</h3>
        ...
        <div class="modal-body">
            <form action="" id="formadd">
                <div class="row">
                    <div class="col-md-6">
                        <div>Cabang</div>
                        <div><b><span id="cabang_name">{{ $data->cabang->name }}</span></b></div>
                    </div>
                </div>
                <div class="row pt-4">
                ...
                <div class="row pt-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="stock" id="stock" class="form-control" readonly value="{{$data->weight}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">

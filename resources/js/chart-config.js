$(document).ready(function () {
    ...
    $.get(base_url+'/sales-purchases/chart-data', function (response) {
    ...
    $.get(base_url+'/current-month/chart-data', function (response) {
    ...
    $.get(base_url+'/payment-flow/chart-data', function (response) {
